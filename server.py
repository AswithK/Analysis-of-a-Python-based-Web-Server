...
PORT = 80  # Open http://127.0.0.2:80 in a browser
        ...
        while True:
            ...
            with conn:
                ...
                if error:
                    ...
                    rsp.append("Last-Modified: Mon Oct 31 6:00:00 2022")
                rsp.append("Server: 124003046 CN")
                rsp.append("\n")
                rsp = '\n'.join(rsp)
...
def cn():
    """serving cn text file"""
    compnetworks = read_file("cn_text.txt")
    serve(compnetworks, "GET", "/cn_text.txt")
